...
INTEGER, PARAMETER       :: dateini = 199712               ! first forecast date
INTEGER, PARAMETER       :: dateend = 199712               ! last  forecast date
...
REAL, DIMENSION(nlon,nlat)      :: senp, cosp, tpm, tn!, tpdn, adn
REAL, DIMENSION(nlon,nlat)      :: pp, pn!, pc, pcn, pcdn, pscdn
REAL, DIMENSION(nlon,nlat)      :: vxdn, vydn
REAL, DIMENSION(nlon,nlat)      :: h500p!, hup, h500a, h500n, h5cdn
        ...
        DO icase = 1 , 2
            ...
            DO j = 1 , nlat
                DO i = 1 , nlon
                    ...
                    f88a(i,j) = - vmn(m) -vydn(i,j)*casedn + f87(i,j)*casedn   &
