...
REAL, DIMENSION(nlon,nlat)      :: tpm, tn, tpdn, adn, senp, cosp
        ...
        DO icase = 1 , 2
            ...
            DO j = 1 , nlat
                DO i = 1 , nlon
                    ...
                    f87a(i,j) = - umn(m) + f87(i,j)*casedn
                    f88a(i,j) = - vmn(m) + f87(i,j)*casedn                     &
...
!IF (icase == 2 ) CALL pressure ( tpn, tpm, tmn, tpdn, h7cdn, pn, pc, pp )
            IF ( icase==1 ) THEN
                m = 1
                DO j = 1 , nlat
                    DO i = 1 , nlon
            ...
            ELSE
                ...
                ENDDO
            ENDIF
!IF (icase == 2 ) CALL advection ( tpn, tpm, tmn, tpdn, h7cdn, pn,pc,pcdn )
            ...
            IF ( icase == 1 ) THEN
                ...
                DO j = 1 , nlat
                    DO i = 1 , nlon
                        ...
                        tpmn(i,j,ext) = tmn(m)
                        !tpsn(i,j,ext) = tsn(m)
                        !aux1(i,j,ext) = f87a(i,j)   ! PRINT OUT NORMAL VARIABLE
                        m      = m + 1
                    ENDDO
                ENDDO
            ELSE
                ...
                DO j = 1 , nlat
                    DO i = 1 , nlon
                        ...
                        !aux2(i,j,ext)  = f87a(i,j)   ! PRINTOUT ANOMAL VARIABLE
                        m = m + 1
                    ENDDO
                ENDDO
            ENDIF
